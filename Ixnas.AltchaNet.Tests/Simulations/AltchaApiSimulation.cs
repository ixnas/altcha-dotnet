...
internal class AltchaApiSimulation
{
    ...
    public AltchaChallenge Generate(int expiryOffsetSeconds = 0)
    {
        ...
        var challengeBytes = SHA256.HashData(challengeRaw);
                                          ...
                                          Func<string, string>? malformVerificationDataFn = null)
    {
        ...
        var fieldsHashBytes = SHA256.HashData(Encoding.UTF8.GetBytes(fieldsCombined));
        ...
        var verificationDataHash = SHA256.HashData(verificationDataBytes);
